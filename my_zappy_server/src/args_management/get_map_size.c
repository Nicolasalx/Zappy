...
static void get_width(const char **argv, server_t *server, int i)
{
...
static void get_height(const char **argv, server_t *server, int i)
{
...
{
    get_width(argv, server, i);
    get_height(argv, server, i);
}
