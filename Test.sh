...
test_invalid_arg_server "-c -1"
test_invalid_arg_server "-c 101"
...
test_invalid_arg_server "-x 10 -y 101"
test_invalid_arg_server "-x 10 -y 101"
test_invalid_arg_server "-x 101 -y 10"
test_invalid_arg_server "-x 101 -y 10"
test_invalid_arg_server "-y 10 -a 101"
...
test_valid_arg_server "-c 1"
test_valid_arg_server "-c 100"
test_valid_arg_server "-n Team1"
# test_valid_arg_server "-p 1" works with sudo only
test_valid_arg_server "-p 65535"
test_valid_arg_server "-p 4242"
test_valid_arg_server "-p 4242 -f 100"
test_valid_arg_server "-p 4242 -f 100 -x 10"
test_valid_arg_server "-p 4242 -f 100 -x 10 -y 10"
test_valid_arg_server "-p 4242 -f 100 -x 10 -y 10 -c 4"
test_valid_arg_server "-p 4242 -f 100 -x 10 -y 10 -c 4 -n Team1 Team2 Team3 Team4"
test_valid_arg_server "-f 100"
test_valid_arg_server "-f 100 -x 10"
test_valid_arg_server "-f 100 -x 10 -y 10"
test_valid_arg_server "-f 100 -x 10 -y 10 -c 4"
test_valid_arg_server "-f 100 -x 10 -y 10 -c 4 -n Team1 Team2 Team3 Team4"
test_valid_arg_server "-x 10"
test_valid_arg_server "-x 10 -y 10"
test_valid_arg_server "-x 10 -y 10 -c 4"
test_valid_arg_server "-x 10 -y 10 -c 4 -n Team1 Team2 Team3 Team4"
test_valid_arg_server "-y 10"
test_valid_arg_server "-y 10 -c 4"
test_valid_arg_server "-y 10 -c 4 -n Team1 Team2 Team3 Team4"
test_valid_arg_server "-c 4"
test_valid_arg_server "-c 4 -n Team1 Team2 Team3 Team4"
